...
class Ui_EditNodeWindow(object):
    ...
    def DelParam(self, edit1, edit2, btn):
        print("del")
        edit1.deleteLater()
        edit2.deleteLater()
        btn.deleteLater()
    ...
    def AddParam(self):
        ...
        lineEdit_1 = QtWidgets.QLineEdit(self.ENscrollAreaParamContents)
        lineEdit_1.setMinimumSize(QtCore.QSize(0, 35))
        lineEdit_1.setMaximumSize(QtCore.QSize(16777215, 35))
        lineEdit_1.setFont(font)
        self.ENgridParam.addWidget(lineEdit_1, self.i, 0, 1, 1)

        lineEdit_2 = QtWidgets.QLineEdit(self.ENscrollAreaParamContents)
        lineEdit_2.setMinimumSize(QtCore.QSize(0, 35))
        lineEdit_2.setMaximumSize(QtCore.QSize(16777215, 35))
        lineEdit_2.setFont(font)
        self.ENgridParam.addWidget(lineEdit_2, self.i, 1, 1, 1)

        pushButton = QtWidgets.QPushButton(self.ENscrollAreaParamContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ENgridParam.addWidget(pushButton, self.i, 2, 1, 1)

        pushButton.clicked.connect(lambda: self.DelParam(lineEdit_1,lineEdit_2,pushButton))
