...
# Form implementation generated from reading ui file 'editnodeswindow.ui'
#
...
class Ui_EditNodesWindow(object):
    def setupUi(self, EditNodesWindow):
        EditNodesWindow.setObjectName("EditNodesWindow")
        EditNodesWindow.resize(800, 400)
        EditNodesWindow.setMinimumSize(QtCore.QSize(800, 400))
        self.gridLayout = QtWidgets.QGridLayout(EditNodesWindow)
        ...
        self.ENTitle = QtWidgets.QFrame(EditNodesWindow)
        ...
        self.ENscrollAreaParam = QtWidgets.QScrollArea(EditNodesWindow)
        ...
        self.retranslateUi(EditNodesWindow)
        QtCore.QMetaObject.connectSlotsByName(EditNodesWindow)

    def retranslateUi(self, EditNodesWindow):
        _translate = QtCore.QCoreApplication.translate
        EditNodesWindow.setWindowTitle(_translate("EditNodesWindow", "Form"))
        self.ENltNameNode.setText(_translate("EditNodesWindow", "Название нода"))
        self.ENSave.setText(_translate("EditNodesWindow", "Сохранить"))
        self.ENLoad.setText(_translate("EditNodesWindow", "Загрузить"))
        self.ENLoadCMD.setText(_translate("EditNodesWindow", "Загрузить cmd"))
        self.ENAddParam.setText(_translate("EditNodesWindow", "+"))
        self.ENltPathRun.setText(_translate("EditNodesWindow", "Путь к исполняемому файлу"))
        self.pushButton_6.setText(_translate("EditNodesWindow", "-"))
        self.pushButton_5.setText(_translate("EditNodesWindow", "-"))
        self.ENltNameParam.setText(_translate("EditNodesWindow", "Название параметра"))
        self.ENltValueParam.setText(_translate("EditNodesWindow", "Значение параметра"))
        self.ENltBool.setText(_translate("EditNodesWindow", "Быстрый доступ"))
